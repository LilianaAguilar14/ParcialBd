      ...
      throw err
        ...
        (err) => {
            if (err) {
                ...
                db.run(insert, ["Juan", "Ramirez", "78852565", "2020JP110D","Juancito2020"])
                db.run(insert, ["Ernesto", "Quintana", "72585268", "2020ER120D","Neto2020"])
                db.run(insert, ["Jose", "Perez", "79562112", "2020JQ130D","Jose2020"])
                db.run(insert, ["María", "Alvarenga", "74231565", "2020MA140D","Maria2020"])
